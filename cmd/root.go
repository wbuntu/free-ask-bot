...
func initFlags() {
	rootCmd.PersistentFlags().StringVarP(&cfgFile, "config", "c", "/etc/free-ask-bot/config.toml", "toml config file")
...
func initConfig() {
	...
	// go-mysql-server -> :memory: -> free-ask-bot:free-ask-bot@tcp(127.0.0.1:6603)/db?charset=utf8mb4&parseTime=True&loc=Local
	// mysql -> free-ask-bot:free-ask-bot@tcp(127.0.0.1:3306)/db?charset=utf8mb4&parseTime=True&loc=Local
	viper.SetDefault("db.type", "sqlite")
	viper.SetDefault("db.dsn", "/var/lib/free-ask-bot/sqlite.db")
